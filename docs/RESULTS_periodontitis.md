...
### 2. Single-cell DE (Wilcoxon, PD vs HC)
...
### 3. MOSAIC-Ω adversarial consensus (the novel architecture)
...
- **Single cohort.** No independent external replication cohort yet (GSE164241 not processed).
...
- fig9_disease_DE.png — volcanoes, pan-signature heatmap, dysregulation burden
- fig10_mosaic_consensus.png — MOSAIC-Ω vs naive biomarker reproducibility
...
Figures: fig14_ai_ablation.png, fig15_ai_metrics.png.
...
periodontal programs (`tables/biology_functional_enrichment.csv`). **Four programs are
enriched AND replicate in the independent cohort:**
...
independent cohorts. Program-by-cell-type map in fig16.
...
Figures: fig16_biology_programs.png. Tables: biology_functional_enrichment.csv,
...
- fig12_crosscohort_replication.png — abundance concordance, per-cell-type DE Spearman, DEG replication, pan-signature replication
- fig13_crosscohort_mosaic_metrics.png — external MOSAIC reproducibility + cross-cohort metrics table
